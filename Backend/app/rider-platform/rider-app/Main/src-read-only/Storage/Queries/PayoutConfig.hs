...
updateByPrimaryKey (Domain.Types.PayoutConfig.PayoutConfig {..}) = do
  ...
  updateWithKV
    [ Se.Set Beam.batchLimit batchLimit,
      ...
      Se.Set Beam.thresholdPayoutAmountPerOrder thresholdPayoutAmountPerOrder,
      ...
      Just
        Domain.Types.PayoutConfig.PayoutConfig
          { batchLimit = batchLimit,
            ...
            remark = remark,
            thresholdPayoutAmountPerOrder = thresholdPayoutAmountPerOrder,
  ...
  toTType' (Domain.Types.PayoutConfig.PayoutConfig {..}) = do
    Beam.PayoutConfigT
      { Beam.batchLimit = batchLimit,
        ...
        Beam.remark = remark,
        Beam.thresholdPayoutAmountPerOrder = thresholdPayoutAmountPerOrder,
