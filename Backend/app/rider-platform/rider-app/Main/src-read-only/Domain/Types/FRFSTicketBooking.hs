...
data FRFSTicketBooking = FRFSTicketBooking
  { _type :: Domain.Types.FRFSQuote.FRFSQuoteType,
    ...
    cashbackSettled :: Kernel.Prelude.Maybe Kernel.Prelude.Bool,
...
data CashbackStatus = PENDING | PROCESSING | SUCCESSFUL | UNSUCCESSFUL | TO_RETRY | NEED_MANUAL_VERIFICATION deriving (Eq, Ord, Show, Read, Generic, ToJSON, FromJSON, ToSchema)
