...
findAllByCashbackSettled :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) => Maybe Int -> Maybe Int -> Maybe Bool -> Maybe CashbackStatus -> m [FRFSTicketBooking]
findAllByCashbackSettled limit offset isCashbackSettled cashbackStatus = do
  findAllWithOptionsKV
    [ Se.And
        [ Se.Is Beam.cashbackSettled $ Se.Eq isCashbackSettled,
