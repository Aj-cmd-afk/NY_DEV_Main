...
ALTER TABLE atlas_app.payout_config ADD COLUMN payout_registration_cgst double precision NOT NULL default 0;
ALTER TABLE atlas_app.payout_config ADD COLUMN payout_registration_fee double precision NOT NULL default 1.0;
ALTER TABLE atlas_app.payout_config ADD COLUMN payout_registration_sgst double precision NOT NULL default 0;
...
ALTER TABLE atlas_app.payout_config ADD COLUMN threshold_payout_amount_per_order double precision NOT NULL default 60.0;
